...
<html lang="en">
  ...
  <body>
      ...
      <div class="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8">
        ...
        >
          <div>
            ...
            <p class="mt-1.5 text-sm text-gray-500">Eksplorasi Gaya yang Mencerminkan Kepribadian Anda!</p>
          </div>
          ...
          <div class="flex items-center gap-4">
            ...
            <a href="https://wa.me/621234567?text=FashionTrend saya mau tanya seputar produk"
              class="inline-block rounded bg-rose-600 px-5 py-3 text-sm font-medium text-white transition hover:bg-rose-700 focus:outline-none focus:ring"
              type="button"
            >
              CONTACT
            </a>
    ...
    <!-- CALL TO ACTION -->
    <section class="overflow-hidden bg-[url(https://images.unsplash.com/photo-1489987707025-afc232f7ea0f?q=80&w=2670&auto=format&fit=crop)] bg-cover bg-top bg-no-repeat">
    ...
    <!-- PRODUCT LIST -->
    <div class="container grid grid-cols-3 gap-4 max-w-4xl mx-auto py-8 ">
